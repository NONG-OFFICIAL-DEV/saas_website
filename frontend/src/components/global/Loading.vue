...
<script setup>
  // Deliberately not a full-screen overlay — see stores/loadingStore.js and
  ...
  // This bar never blocks clicks (no backdrop, not `persistent`) and sits
  // above everything only visually.
