      ...
      <div v-if="modelValue" class="mobile-drawer">
        ...
        <nav class="drawer-nav">
          <template v-for="section in sections" :key="section.key">
            <router-link v-if="section.type === 'link'" :to="section.to" class="drawer-link" @click="close">
              {{ section.label }}
              <svg
            ...
            <div v-else class="drawer-group">
              ...
              <div v-if="openSections[section.key]" class="drawer-subitems">
                ...
                <router-link v-if="section.viewAllTo" :to="section.viewAllTo" class="drawer-subitem drawer-view-all" @click="close">
        ...
        <router-link to="/login" class="drawer-login" @click="close">
          {{ t('button.log_in') }}
        </router-link>
        <router-link to="/get-started" class="drawer-cta" @click="close">
