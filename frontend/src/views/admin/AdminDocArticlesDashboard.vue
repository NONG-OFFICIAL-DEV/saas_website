<template>
  <div>
    <div class="dash-header">
      ...
      <v-btn color="primary" variant="flat" rounded="lg" prepend-icon="mdi-plus" :to="{ name: 'admin-doc-article-new' }">
        New article
      </v-btn>
    </div>
    ...
    <div v-else class="dash-table">
      ...
      <div v-for="item in articles" :key="item.id" class="dash-row">
        ...
        <span class="dash-actions">
          <v-btn size="small" variant="text" icon="mdi-pencil-outline" :to="{ name: 'admin-doc-article-edit', params: { id: item.id } }" />
