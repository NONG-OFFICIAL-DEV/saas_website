<template>
  <div>
    <div class="dash-header">
      ...
      <v-btn color="primary" variant="flat" rounded="lg" prepend-icon="mdi-plus" :to="{ name: 'admin-doc-category-new' }">
        New category
      </v-btn>
    </div>
    ...
    <div v-else class="dash-table">
      ...
      <div v-for="item in categories" :key="item.id" class="dash-row">
        ...
        <span class="dash-actions">
          <v-btn size="small" variant="text" icon="mdi-pencil-outline" :to="{ name: 'admin-doc-category-edit', params: { id: item.id } }" />
