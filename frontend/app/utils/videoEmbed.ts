...
// allowlist (pages/documentation/[slug].vue) — one place that defines what
// counts as a real, embeddable YouTube/Vimeo URL.
...
export function isAllowedEmbedSrc(src: unknown): boolean {
